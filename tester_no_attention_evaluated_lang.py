...
encoder2.load_state_dict(torch.load('encoder_no_attn_collated.pth', map_location=torch.device('cpu')))
attn_decoder2.load_state_dict(torch.load('decoder_no_attn_collated.pth', map_location=torch.device('cpu')))
